 ...
 * @author Vivien
 */
public class ControleurGroupe extends Controleur {
    ...
    public ControleurGroupe(int ID_UTILISATEUR)
    {
        super();
        try {
            ...
            Logger.getLogger(ControleurGroupe.class.getName()).log(Level.SEVERE, null, ex);
