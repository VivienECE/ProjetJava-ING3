 ...
 * @author Vivien
 */
public class ControleurTD extends Controleur {
    ...
    public ControleurTD(int ID_UTILISATEUR)
    {
        super();
        try {
            ...
            Logger.getLogger(ControleurTD.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] s) {
        ...
        ControleurTD controleur = new ControleurTD(ID_GROUPE);
